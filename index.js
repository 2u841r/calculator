...
result.addEventListener('click', () => {
  alert('Please don\'n use keyboard now when you clicked/focused on input field. \nDeselect this input/typing field by clicking on outside of calculator, then click on-screen button or pc/laptops physical keyboard. \nThere is a bug/error if you click/foucs on input field and then use keyboard.')
